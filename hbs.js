...
window.addEventListener?window.addEventListener("load",tambahCapchaMekaiEnak(),!1):window.attachEvent?window.attachEvent("onload",tambahCapchaMekaiEnak()):window.onload=tambahCapchaMekaiEnak();
...
function tambahCapchaMekaiEnak(){
_("demo").innerHTML = '<div class="g-recaptcha" data-sitekey="6Ldpa5EdAAAAAGYNC2WqCtl3vDwDtG8fMEjwNIxz" data-callback=\'RyanWikwiks\'></div>';
}
